    ...
    public function index(Request $request)
    {
        ...
        $formatted = $activities->through(function ($item) {
            return [
                ...
                'deadline' => $item->deadline ? $item->deadline->format('Y-m-d H:i') : null,
        ...
        try {
            ...
            return response()->json([
                ...
                'data' => [
                    ...
                    'deadline' => $activity->deadline ? $activity->deadline->format('Y-m-d H:i') : null,
        ...
        $activities = Activity::query()
            ...
            ->through(function ($item) {
                return [
                    ...
                    'deadline' => $item->deadline?->format('Y-m-d H:i'),
                    'start_time' => $item->start_time ? substr($item->start_time, 0, 5) : null,
                    'end_time' => $item->end_time ? substr($item->end_time, 0, 5) : null,
                    'location' => $item->location,
                ];
