    ...
    <header className="sticky top-0 z-50 bg-white border-b border-gray-200">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          {/* Logo */}
          <Link href={user ? "/dashboard" : "/"} className="flex-shrink-0 flex items-center gap-3">
            <img
          ...
          <div className="flex items-center gap-3">
            ...
            {user && (
              <Link
                href="/notifications"
                className="relative p-2 text-gray-500 hover:text-gray-700 hover:bg-gray-100 rounded-full transition-colors mr-1"
            ...
            {/* User Greeting + Dropdown or Guest Buttons */}
            {user ? (
              ...
              <div className="hidden lg:flex items-center gap-3">
                ...
                <Link
                  href="/register"
                  className="px-5 py-2 bg-gradient-to-r from-amber-500 to-orange-500 hover:from-amber-600 hover:to-orange-600 text-white text-sm font-semibold rounded-xl shadow-md shadow-amber-500/20 hover:shadow-amber-500/30 transition-all hover:-translate-y-0.5"
                >
                  Daftar
                </Link>
              </div>
            ...
            {user ? (
              ...
              <div className="mt-3 pt-3 border-t border-gray-100 flex flex-col gap-2 px-3">
                <Link
                  href="/login"
                  onClick={() => setMobileOpen(false)}
                  className="w-full text-center py-2.5 text-sm font-semibold text-gray-600 hover:text-gray-800 border border-gray-200 rounded-xl transition-colors"
                >
                  Masuk
                </Link>
                <Link
                  href="/register"
                  onClick={() => setMobileOpen(false)}
                  className="w-full text-center py-2.5 bg-gradient-to-r from-amber-500 to-orange-500 text-white text-sm font-semibold rounded-xl shadow-sm transition-all"
                >
                  Daftar
                </Link>
              </div>
