...
function MenuLainButton() {
  ...
  return (
    <div ref={ref} className="relative">
      ...
      >
        <div className="w-14 h-14 rounded-xl bg-gradient-to-br from-gray-100 to-gray-200 text-gray-500 flex items-center justify-center group-hover:scale-110 transition-transform">
          {/* 3x3 dots grid icon */}
        ...
        <span className="text-sm font-semibold text-gray-800">Menu Lain</span>
      </button>
    ...
    <AppLayout>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-5">
          ...
          {/* Menu Lain — replaces the old Profile card */}
          <MenuLainButton />
        </div>
